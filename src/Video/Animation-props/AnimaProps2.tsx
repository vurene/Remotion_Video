...
// Styled Component for opacity animation
...
// interpolate function for animating Opacity of First text layer (fading it out)
		const Fadeout = interpolate(frame, [280, 300],[1,0 ],
			{extrapolateLeft: 'clamp', extrapolateRight:'clamp'})
// interpolate function for animating Opacity of Second text layer (fading it in)
	...
	{/*______________ First Text Layer _____________*/}
...
{/*______________ Second Text Layer _____________*/}
		...
		<Text style={{
			...
			we map the frames
			<TextBlue> 0 to 20 to </TextBlue>
			their opacity values
			<TextBlue> (0, 0.05, 0.1, 0.15 ...)</TextBlue>
			<br/> 
			and use the extrapolateRight setting to clamp the output
			<br/> 
			so that it 
			<TextBlue>never becomes bigger than 1</TextBlue> 
